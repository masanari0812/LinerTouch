...
class KanaKeyboard:
    def __init__(self, master):
        ...
        self.kana_map = {
            (0, 0): "あ", (1, 0): "い", (2, 0): "う", (3, 0): "え", (4, 0): "お",
            (0, 1): "か", (1, 1): "き", (2, 1): "く", (3, 1): "け", (4, 1): "こ",
            (0, 2): "さ", (1, 2): "し", (2, 2): "す", (3, 2): "せ", (4, 2): "そ",
            (0, 3): "た", (1, 3): "ち", (2, 3): "つ", (3, 3): "て", (4, 3): "と",
            (0, 4): "な", (1, 4): "に", (2, 4): "ぬ", (3, 4): "ね", (4, 4): "の",
            (0, 5): "は", (1, 5): "ひ", (2, 5): "ふ", (3, 5): "へ", (4, 5): "ほ",
            (0, 6): "ま", (1, 6): "み", (2, 6): "む", (3, 6): "め", (4, 6): "も",
            (0, 7): "や", (1, 7): "ゆ", (2, 7): "よ",
            (0, 8): "ら", (1, 8): "り", (2, 8): "る", (3, 8): "れ", (4, 8): "ろ",
            (0, 9): "わ", (1, 9): "を", (2, 9): "ん",
        }
        ...
        self.canvas.bind("<B3-Motion>", self.on_canvas_drag)  # マウスドラッグイベント
        self.canvas.bind("<ButtonRelease-1>", self.on_canvas_release)  # マウスリリースイベント
    ...
    def draw_pointer(self):
        ...
        x = self.pointer_x * (self.button_width + self.key_margin) + self.key_margin + self.button_width / 2
        y = self.pointer_y * (self.button_height + self.key_margin) + self.key_margin + self.button_height / 2
    ...
    def input_kana(self):
        ...
        if kana:
            print(f"入力: {kana}")  # 入力された文字をコンソールに出力（必要に応じてテキストボックス等に変更）
    ...
    def on_canvas_click(self, event):
        ...
        for (col, row), kana in self.kana_map.items():
            ...
            if scaled_x <= canvas_x <= scaled_x + scaled_width and scaled_y <= canvas_y <= scaled_y + scaled_height:
                print(f"入力: {kana}")
                break
